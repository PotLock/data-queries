-- Humans After the Complete NEAR Social Profile Check Score Was Reduced Mid Round https://flipsidecrypto.xyz/wownorth/q/pmgCRBnt4Z8B/human-after-change && https://flipsidecrypto.xyz/wownorth/plotlock-plotlock-A36Irq
WITH txns as (
  select
    distinct tx_hash,
...
from human_list_previouse) q, (select count(*) as current_count from  human_list_current) c
