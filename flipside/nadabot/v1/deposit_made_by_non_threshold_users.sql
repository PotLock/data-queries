-- Total Deposits Made By Non Verified Users on nadabot https://flipsidecrypto.xyz/wownorth/q/pUVHg1D0azzG/total-deposit-make-by-non-verified-users && https://flipsidecrypto.xyz/wownorth/plotlock-plotlock-A36Irq?tabIndex=2
WITH txns as (
  select
    distinct tx_hash,
