-- protocol fee to impact.sputnik-dao.near Potluck Foundation DAO from Pots https://flipsidecrypto.xyz/Lordking/q/vaYo7V29If94/protocol-fee---pot-direct-leaderboard  && https://flipsidecrypto.xyz/Lordking/potlock-UD3Flm?tabIndex=2
...
select 
      ...
      count(distinct RECEIVER_ID )as "Project", 
      sum(impact_DEPOSIT) as "Protocol Fee (near)" ,
